<template>
  <div class="app-container">
    ...
    >
      <el-table-column :label="$t('user.id')" prop="id" sortable="custom" align="center" width="80">
        <template slot-scope="scope">
          <span>{{ scope.row.Id }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('user.rtype')" prop="id" sortable="custom" align="center" width="140">
        <template slot-scope="scope">
          <span>{{ scope.row.RegisterType }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('user.mobile')" width="168px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.Mobile }}</span>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip :label="$t('user.email')" width="160px" align="center">
        <template slot-scope="scope">
          <span> {{ scope.row.Email }}</span>
        </template>
      </el-table-column>

      <el-table-column show-overflow-tooltip :label="$t('user.address')" width="200px" align="center">
        <template slot-scope="scope">
          <span style="color:red;"> {{ scope.row.AccountAddress }} </span>
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('user.registime')" width="136px" align="center">
        <template slot-scope="scope">
