<template>
  <div class="app-container">
    ...
    >
      <el-table-column :label="$t('cluster.id')" prop="id" sortable="custom" align="center" width="80">
        <template slot-scope="scope">
          <span>{{ scope.row.Id }}</span>
        </template>
      </el-table-column>

      <el-table-column show-overflow-tooltip :label="$t('cluster.rid')" prop="id" sortable="custom" align="center" width="140">
        <template slot-scope="scope">
          <span>{{ scope.row.Rid }}</span>
        </template>
      </el-table-column>

      <el-table-column show-overflow-tooltip :label="$t('cluster.clustername')" width="168px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.Name }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('cluster.rancherId')" width="90px" align="center">
        <template slot-scope="scope">
          <span style="color:red;"> {{ scope.row.RancherId }}</span>
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip :label="$t('cluster.Profit')" align="center" width="90">
        <template slot-scope="{row}">
          <span class="link-type" click="handleFetchPv(row.pageviews)">
            {{ row.Profit }} </span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('cluster.ownerId')" width="90px" align="center">
        <template slot-scope="scope">
          <span style="color:red;"> {{ scope.row.OwnerId }} </span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('cluster.status')" class-name="status-col" width="100">
        <template slot-scope="{row}">
      ...
      <el-table-column :label="$t('cluster.beginTime')" width="136px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.BeginTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('cluster.endTime')" width="136px" align="center">
        <template slot-scope="scope">
...
import { getClusterList, deleteCluster } from '@/api/cluster'
