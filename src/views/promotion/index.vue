<template>
  <div class="app-container">
    ...
    >
      <el-table-column :label="$t('promo.id')" prop="id" sortable="custom" align="center" width="80">
        <template slot-scope="scope">
          <span>{{ scope.row.Id }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('promo.promoname')" prop="id" sortable="custom" align="center" width="140">
        <template slot-scope="scope">
          <span>{{ scope.row.Name }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('promo.content')" width="360px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.Content }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('promo.status')" class-name="status-col" width="100">
      ...
      <el-table-column :label="$t('promo.begindate')" width="136px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.CreateTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('promo.enddate')" width="136px" align="center">
        <template slot-scope="scope">
...
import { getPromos, deletePromo } from '@/api/promo'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getPromos(this.listQuery).then(response => {
